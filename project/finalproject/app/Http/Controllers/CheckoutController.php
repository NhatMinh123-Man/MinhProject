...
class CheckoutController extends Controller
{
    ...
    public function login_checkout(Request $request){
       ...
       $meta_desc="Login";
       $meta_keywords="Login";
       $meta_title="Login account";
       $url_canonical=$request->url();        
       //end seo  
        
        return view('pages.checkout.login_check')->with('category',$cate_product)->with('brand',$brd_product)->with('slider',$slider)
    ...
    public function checkout(Request $request){
        ...
        $meta_title="Checkout payment";
        $url_canonical=$request->url();        
        //end seo  
        
        $city=City::orderby('matp','ASC')->get();
        
        return view('pages.checkout.show_checkout')->with('category',$cate_product)->with('brand',$brd_product)->with('slider',$slider)
        ->with('meta_desc', $meta_desc)
        ->with('meta_keywords', $meta_keywords)
        ->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)
        ->with('city',$city);
    ...
    public function order(Request $request){
        ...
        $data['payment_status']='Wait a moment';
        ...
        $order_data['order_code']=Cart::total();
        $order_data['order_status']='Wait a moment';
        ...
        //end seo  
            ...
            Cart::destroy();
            return view('pages.checkout.cash')->with('category',$cate_product)->with('brand',$brd_product)  
            ->with('meta_desc', $meta_desc)
            ->with('meta_keywords', $meta_keywords)
            ->with('meta_title',$meta_title)->with('url_canonical',$url_canonical);
...
//ADMIN
    ...
    public function calculate_fee(Request $request){
        $data = $request->all();
        if($data['matp']){
            $feeship=Feeship::where('fee_city',$data['matp'])->where('fee_distr',$data['maqh'])
            ->where('fee_ward',$data['xaid'])->get();
            if ($feeship){
