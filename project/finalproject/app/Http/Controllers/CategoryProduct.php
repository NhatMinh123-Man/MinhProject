...
{   
    ...
    //Fontend
    public function show_cate_home(Request $request, $category_id){
        ...
        return view('pages.category.show_cate')->with('category',$cate_product)->with('brand',$brd_product)->with('slider',$slider)
