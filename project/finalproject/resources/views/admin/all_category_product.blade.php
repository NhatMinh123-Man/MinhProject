    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tr>
            ...
            </td> <td>{{$cate_pro->category_desc}}</td>
            <td>
              <a href="{{URL::to('/edit-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class="">
                ...
                <a onclick="return confirm('Do you want detelet this product ?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class="">
