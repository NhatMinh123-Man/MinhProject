...
<body>
	...
	$(document).ready(function(){
			$('.send_order').click(function(){
				swal({
					title: "Confirm Order?",
					text: "Your order cannot refunds, Are you sure want to continue order?",
					type: "warning",
					showCancelButton: true,
				...
				function(isConfirm){
					if(isConfirm){
						...
						$.ajax({
							...
							data:{shipping_email:shipping_email,shipping_name:shipping_name,
								...
								shipping_note:shipping_note,shipping_method:shipping_method,
								order_fee:order_fee,order_coupon:order_coupon,_token:_token},
							success:function(data){
					...
					window.setTimeout(function(){ 
						...
						swal("Cancel Order", "Please Order Again", "error");
					}
		});
	});
})
